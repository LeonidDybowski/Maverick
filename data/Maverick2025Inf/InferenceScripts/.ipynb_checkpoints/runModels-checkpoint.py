...
def main ( argv ):
    ...
    Arc1Model1.load_weights('Maverick/weights/weights_TransformerNetDiff_model_1')
    Arc1Model2 = MaverickArchitecture1()
    Arc1Model2.load_weights('Maverick/weights/weights_TransformerNetDiff_classWeights_1_2_7_model_1')
    Arc1Model3 = MaverickArchitecture1()
    Arc1Model3.load_weights('Maverick/weights/weights_TransformerNetDiff_classWeights_1_2_7_model_2')
    Arc2Model1 = MaverickArchitecture2()
    Arc2Model1.load_weights('Maverick/weights/weights_T5_withBiLSTM_TransformerNet_altOnly_model_4')
    Arc2Model2 = MaverickArchitecture2()
    Arc2Model2.load_weights('Maverick/weights/weights_T5_withBiLSTM_TransformerNet_altOnly_model_5')
    Arc2Model3 = MaverickArchitecture2()
    Arc2Model3.load_weights('Maverick/weights/weights_T5_withBiLSTM_TransformerNet_altOnly_model_7')
    Arc2Model4 = MaverickArchitecture2()
    Arc2Model4.load_weights('Maverick/weights/weights_T5_withBiLSTM_TransformerNet_altOnly_classWeights_1_2_3_model_1')
    Arc2Model5 = MaverickArchitecture2()
    Arc2Model5.load_weights('Maverick/weights/weights_T5_withBiLSTM_TransformerNet_altOnly_classWeights_1_2_7_model_1')
