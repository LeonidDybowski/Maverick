...
if [[ "$genome" == "grch37" ]]; then bash Maverick2025/InferenceScripts/scoreVariants.sh ${fileName}
else bash Maverick2025/InferenceScripts/scoreVariants_GRCh38.sh ${fileName}
fi
