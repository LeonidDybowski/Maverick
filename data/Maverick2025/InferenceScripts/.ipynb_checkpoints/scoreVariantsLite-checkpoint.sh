...
resources/annovar/annotate_variation.pl -dbtype wgEncodeGencodeBasicV33lift37 -buildver hg19 --exonicsplicing ${BASE}.avinput resources/annovar/humandb/
...
python Maverick2025/InferenceScripts/runModelsLite.py --inputBase=${BASE}

python Maverick2025/InferenceScripts/rankVariantsLite.py --inputBase=${BASE}
