...
python Maverick2025/InferenceScripts/runModelsLite_GRCh38.py --inputBase=${BASE}

python Maverick2025/InferenceScripts/rankVariantsLite_GRCh38.py --inputBase=${BASE}
