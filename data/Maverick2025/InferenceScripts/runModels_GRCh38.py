...
class DataGenerator(keras.utils.Sequence):
	...
	def __data_generation(self, list_IDs_temp):
		...
		for i, ID in enumerate(list_IDs_temp):
			...
			tmp=np.load("HHMProfiles/" + transcriptID + "_MMSeqsProfile.npz",allow_pickle=True)
			tmp=tmp['arr_0']
			seqLen=tmp.shape[0]
			startPos=changePos-self.padding
...
def main ( argv ):
	...
	trainingData=pandas.read_csv(resources + 'trainingSet_data2025_ann2025_hg38_test_known2020.txt',sep='\t',low_memory=False)
	...
	Arc1Model1.load_weights('Maverick2025/weights/Architecture1_Model1.weights.h5')
	Arc1Model2 = MaverickArchitecture1()
	Arc1Model2.load_weights('Maverick2025/weights/Architecture1_Model2.weights.h5')
	Arc1Model3 = MaverickArchitecture1()
	Arc1Model3.load_weights('Maverick2025/weights/Architecture1_Model3.weights.h5')
	Arc2Model1 = MaverickArchitecture2()
	Arc2Model1.load_weights('Maverick2025/weights/Architecture2_Model1.weights.h5')
	Arc2Model2 = MaverickArchitecture2()
	Arc2Model2.load_weights('Maverick2025/weights/Architecture2_Model2.weights.h5')
	Arc2Model3 = MaverickArchitecture2()
	Arc2Model3.load_weights('Maverick2025/weights/Architecture2_Model3.weights.h5')
	Arc2Model4 = MaverickArchitecture2()
	Arc2Model4.load_weights('Maverick2025/weights/Architecture2_Model4.weights.h5')
	Arc2Model5 = MaverickArchitecture2()
	Arc2Model5.load_weights('Maverick2025/weights/Architecture2_Model5.weights.h5')
